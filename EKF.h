...
//#define K_gain_debug							 	
#ifdef K_gain_debug		
		cout << "Predicted State :" << endl;
                //Serial.println("Predicted State :");
		X_p.afficher();
		cout << "Predicted Covariance : " << endl;
                //Serial.println("Predicted Covariance : ");
		Sigma_p.afficher();
		cout << "Kalman Gain : " << endl;	
		...
		Sigma->afficher();		
#endif		
		//cout << " L'execution de l'EKF a prise : " << (float)(clock()-(float)timer)/(float)CLOCKS_PER_SEC << " secondes." << endl;
	}
